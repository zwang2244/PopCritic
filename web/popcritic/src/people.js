...
export default function Movie() {
  ...
  useEffect(() => {
    ...
    fetch("https://stark-taiga-39691.herokuapp.com/https://popcritic.herokuapp.com/people/"+query).then(resp => resp.json()).then((data) => setPeople(data)).catch(() => {window.location.href="/"});
  },[])
